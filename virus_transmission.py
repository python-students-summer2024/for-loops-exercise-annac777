...
def calculate_infections(starting_number_infections, reproduction_rate, num_days):
    ...
    """
    infections_number = starting_number_infections
    
    for i in range(num_days):
        new_infections = infections_number * reproduction_rate
        infections_number = new_infections
        
    return round(infections_number)
